...
namespace MapDemo {
    ...
    public class DemoValuesProvider {
        const string key = "Ai_8HuOcqd5uYbzXx5H1ki1S9rjkSkXYeSUwirz4Gf5IO0TaSY0OtG8xmwowu2RY";
    ...
    public class CityWeather : BindableBase {
        ...
        public virtual string WeatherIconPath { get; set; }
        public virtual ObservableCollection<CityWeather> Forecast { get; set; }
        public virtual string TemperatureValueDataMember { get; set; }
        public virtual string TemperatureString { get; set; }
        public virtual string CrosshairLabelPattern { get; set; }
        ...
        public void SetForecast(ObservableCollection<OpenWeatherMapService.CityWeatherInfo> forecast) {
            ...
            foreach(OpenWeatherMapService.CityWeatherInfo cityWeatherInfo in forecast)
                cityWeatherList.Add(ViewModelSource.Create(() => new CityWeather(cityWeatherInfo)));
    ...
    public class OpenWeatherMapService : BindableBase {
        ...
        public virtual ObservableCollection<CityWeather> WeatherInCities { get; set; }
